  ...
  return (
    <footer className="bg-[#08325A] mt-20">
      <footer className="lg:flex justify-around pt-8 lg:pt-12 lg:max-w-[90%] mx-auto text-white">
        ...
        <nav>
          <h6 className="text-xl text-center uppercase font-semibold opacity-80">Social</h6>
      ...
      <h1 className="text-white mt-8 text-center pb-12 font-saira">
