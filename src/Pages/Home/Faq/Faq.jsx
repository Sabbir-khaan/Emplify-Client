    ...
    <section className="lg:max-w-[80%] mx-auto font-dosis p-3">
      ...
      >
        ...
        <h2 id="accordion-color-heading-2">
          ...
          >
            <span className="text-xl">Can Emplify integrate with other tools we already use?</span>
            <svg
              data-accordion-icon
              className="w-3 h-3 rotate-180 shrink-0"
              aria-hidden="true"
        ...
        <h2 id="accordion-color-heading-4">
          ...
          >
            <span className="text-xl">Do employees need training to use Emplify?</span>
            <svg
              data-accordion-icon
              className="w-3 h-3 rotate-180 shrink-0"
              aria-hidden="true"
        ...
        <h2 id="accordion-color-heading-5">
          ...
          >
            <span className="text-xl">What kind of support does Emplify provide?</span>
            <svg
              data-accordion-icon
              className="w-3 h-3 rotate-180 shrink-0"
              aria-hidden="true"
